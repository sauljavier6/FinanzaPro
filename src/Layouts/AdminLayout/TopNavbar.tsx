...
import { getdataSearch } from "../../api/AdminApis/layoutApi";
import { useRef, useEffect } from "react";
import { getNotificacionesCount } from "../../api/AdminApis/NotificacionesApi";
...
export default function TopNavbar({ onMenuClick }: TopNavbarProps) {
  ...
  const { data } = useQuery({
    queryKey: ["layoutbuscaradmin", search],
    ...
    <header className="sticky top-0 z-30 bg-white/90 dark:bg-background-dark/90 backdrop-blur-md border-b border-border-color dark:border-gray-800">
      <div className="flex items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8 py-3 md:py-4">
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          ...
          <button className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-slate-100 dark:hover:bg-gray-800">
