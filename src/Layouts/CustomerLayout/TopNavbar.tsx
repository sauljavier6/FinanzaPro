  ...
  return (
    <header className="sticky top-0 z-10 flex items-center justify-between bg-white/90 dark:bg-background-dark/90 backdrop-blur-md border-b border-border-color dark:border-gray-800 px-8 py-4">
      ...
      <div className="flex items-center gap-6">
        <button onClick={() => navigate("/clientes/notificaciones")} className="relative p-2 text-slate-500 hover:bg-slate-100 dark:hover:bg-gray-800 rounded-lg transition-colors">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => navigate("/clientes/configuracion")} className="relative p-2 text-slate-500 hover:bg-slate-100 dark:hover:bg-gray-800 rounded-lg transition-colors">
