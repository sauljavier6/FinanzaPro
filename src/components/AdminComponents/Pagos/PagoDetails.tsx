        ...
        <div className="flex w-full max-w-full overflow-x-hidden">
            <main className="flex-1 min-w-0 flex flex-col overflow-y-auto overflow-x-hidden bg-background-light dark:bg-background-dark">
                <div className="w-full max-w-full p-3 sm:p-8 overflow-x-hidden">
                    ...
                    <div className="grid w-full max-w-full grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 mb-4 min-w-0">
                        <div className="min-w-0 flex flex-col gap-2 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm overflow-hidden">
                            <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm font-medium uppercase tracking-wider">
                                Total Facturado
                            </p>
                            <p className="text-gray-900 dark:text-white tracking-tight text-2xl sm:text-3xl font-black break-words">
                        ...
                        <div className="min-w-0 flex flex-col gap-2 rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm overflow-hidden sm:col-span-2 xl:col-span-1">
                            <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm font-medium uppercase tracking-wider">
                                Saldo Pendiente
                            </p>
                            <p className="text-primary tracking-tight text-2xl sm:text-3xl font-black break-words">
                            ...
                            <div
                                className={`flex items-center gap-1 text-xs font-bold px-2 py-1 rounded w-fit max-w-full ${data?.data?.estatusColor} dark:bg-opacity-20`}
                            >
                                ...
                                <div className="space-y-4 min-w-0">
                                    ...
                                    {hasRole(1, 2) && (
                                        <button className="w-full bg-white text-primary font-bold py-3 sm:py-3.5 rounded-xl hover:bg-gray-100 transition-all duration-200 flex items-center justify-center gap-2 mt-4 text-sm sm:text-base active:scale-[0.98]">
                                            ...
                                            <span className="truncate">Enviar Comprobante</span>
                                        </button>
                                    )}
                                </div>
                            </div>
