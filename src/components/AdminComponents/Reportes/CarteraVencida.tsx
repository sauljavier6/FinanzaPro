...
import { getClienteCV, getReporteCV } from "../../../api/AdminApis/reportesApi";
...
export default function CarteraVencida() {
    ...
    const { data } = useQuery({
        queryKey: ["buscarcarteravencida", search],
    ...
    const {
        ...
        queryFn: () => getReporteCV(parametrosReporte),
    ...
    const handlePrintReporte = async () => {
        ...
        try {
            window.open(`${import.meta.env.VITE_API_URL}/admin/reportes/carteravencidaexcel?${query}`);
        } catch (error) {
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                        <div className="min-w-0">
                            ...
                            <p className="text-sm text-[#64748b] mt-1 break-words">
                                Seguimiento de saldos vencidos, antigüedad de deuda y clientes con riesgo para optimizar la gestión de cobranza.
                            </p>
                        </div>
                        {/* BOTÓN */}
                        <button
                            ...
                            <div className="flex items-end justify-between gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl sm:text-2xl font-extrabold">
                                        {formatoMoneda.format(reporte?.data?.totalVencido || 0)}
                                    </h3>
                                </div>

                                <div className="hidden sm:flex h-12 w-20 items-end gap-1">

                                    <div className="w-2 bg-red-200 h-[60%] rounded-full"></div>
                                    <div className="w-2 bg-red-300 h-[80%] rounded-full"></div>
                                    <div className="w-2 bg-red-400 h-[70%] rounded-full"></div>
                                    <div className="w-2 bg-red-500 h-[90%] rounded-full"></div>
                                    <div className="w-2 bg-red-600 h-[100%] rounded-full"></div>
                        ...
                        <div className="bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-2xl border border-card-border dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <div className="flex items-end justify-between gap-4">
                                ...
                                <div className="hidden sm:flex h-12 w-12 relative items-center justify-center">
                                    ...
                                    <span className="absolute text-[9px] font-bold">{reporte?.data?.porcentajePagado.toFixed(2)}%</span>
                                </div>
                            </div>
                        </div>
